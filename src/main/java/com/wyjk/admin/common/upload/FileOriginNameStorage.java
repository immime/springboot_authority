...
public class FileOriginNameStorage implements IFileStorage {
	private final Path rootLocation;
	private final String uploadDir;

	public FileOriginNameStorage(String uploadDir) {
	...
	public String store(MultipartFile file) {
		...
		Path fullPath = this.rootLocation.resolve(originalFilename);
		try {
	...
	public String store(MultipartFile file, String path) {
		...
		Path fullPath = rootPath.resolve(originalFilename);
		try {
	...
	public String store(MultipartFile file, String path, String subPathName) {
		...
		Path fullPath = subPath.resolve(originalFilename);		
		try {			
			if (!Files.exists(rootPath)) {
				Files.createDirectories(rootPath);
			}
		...
		String url = "/" + path + "/" + subPathName + "/" + originalFilename;
		return url;
	}
	...
	public String store(MultipartFile file, String... paths) {
		...
		path = path.resolve(originalFilename);
		try {
