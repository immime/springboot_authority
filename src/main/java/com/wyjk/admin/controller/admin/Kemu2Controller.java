...
import com.wyjk.admin.service.IKemu2Service;
import com.wyjk.admin.vo.KemuPostVO;

@Controller
@RequestMapping("/admin/kemu2")
public class Kemu2Controller extends BaseController {
	
	@Value("${app.upload.fileDomain}")
	private String fileDomain;
	@Autowired
	private IKemu2Service service;
	
	@RequestMapping(value = { "/", "/index" })
	public String index() {
		return "admin/content/kemu2/index";
	}
	...
	public String add(ModelMap map) {
		return "admin/content/kemu2/form";
	}
