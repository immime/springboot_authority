 ...
 * plugin, and can have many children themselves.
 *
...
vjs.Component = vjs.CoreObject.extend({
  ...
  init: function(player, options, ready){
    ...
    // Add any child plugin in options
    this.initChildren();
...
/**
 * Dispose of the component and all child plugin
 */
 ...
 *
 * This is used for merging options for child plugin. We
...
/**
 * Get an array of all child plugin
 *
...
/**
 * Object of child plugin by name
 *
 * @type {Object}
 * @private
 */
...
/**
 * Add and initialize default child plugin from options
 *
...
vjs.Component.prototype.initChildren = function(){
  ...
  if (options && options['children']) {
    ...
    // Loop through plugin and add them to the player
    vjs.obj.each(options['children'], function(name, opts){
      // Allow for disabling default plugin
      // e.g. vjs.options['children']['posterImage'] = false
      if (opts === false) return;

      // Allow waiting to add plugin until a specific event is called
...
/**
 * Allows sub plugin to stack CSS class names
 *
 ...
 * If you set this.isReadyOnInitFinish_ it will affect all plugin.
...
vjs.Player = vjs.Component.extend({
  ...
  init: function(tag, options, ready){
    ...
    // Inits and embeds any child plugin in opts
...
// When the player is first initialized, trigger activity so plugin
