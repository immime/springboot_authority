...
<body class="gray-bg">
    ...
    <script>
        ...
        function edit(id){
        	location.href = '${ctx!}/admin/kemu2/edit/' + id;
        }
        function add(){
        	location.href = '${ctx!}/admin/kemu2/add';
        }
        function updateSort(id, upOrDown) {
        	...
        	$.ajax({
	    		   ...
	    		   url: "${ctx!}/admin/kemu2/updateOrder",
